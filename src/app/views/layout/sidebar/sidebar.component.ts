...
import { MENUADMIN, MENUPASAJERO, MENUPILOTO } from './menu';
...
export class SidebarComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    // DEFINIMOS EL MENU QUE SE VA A UTILIZAR SEGUN EL ROL DEL USUARIO
    if (localStorage.getItem('rol_asignado') == 'admin'){
      this.menuItems = MENUADMIN;
    }else if (localStorage.getItem('rol_asignado') == 'piloto'){
      this.menuItems = MENUPILOTO;
    }else if (localStorage.getItem('rol_asignado') == 'pasajero'){
      this.menuItems = MENUPASAJERO;
    }
